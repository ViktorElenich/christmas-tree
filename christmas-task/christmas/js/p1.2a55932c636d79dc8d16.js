...
class Game extends pages_1.Page {
    ...
    savePlayAudio(event) {
        ...
        const localStorages = new localStorage_1.LocalStorageUtil();
    ...
    afterRender() {
        ...
        bgItems.forEach(bgItem => {
            ...
            const bgContainers = document.querySelector('.tree-container');
